set --export POSH_THEME '/home/franzs/.cache/oh-my-posh/config.e7cb36c73b0a8ccd4b0824b8f16a5df61bbc9bfcef5c8529c28c6238a9d9b472.omp.json'
set --export POSH_SHELL_VERSION $FISH_VERSION
set --export POWERLINE_COMMAND oh-my-posh
set --export POSH_SESSION_ID b134226d-a59f-406d-aead-0467e0c5fa54
...
set --global _omp_executable /usr/bin/oh-my-posh
...
test -r '/home/franzs/.opam/opam-init/init.fish' && source '/home/franzs/.opam/opam-init/init.fish' >/dev/null 2>/dev/null; or true
